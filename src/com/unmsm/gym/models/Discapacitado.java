...
public class Discapacitado extends Estudiante {
    ...
    /*           Getters y setters           */
    public TipoDeDiscapacidad obtenerTipoDeDiscapacidad() { return tipoDeDiscapacidad; }
    public void establecerTipoDeDiscapacidad(TipoDeDiscapacidad tipoDeDiscapacidad) { this.tipoDeDiscapacidad = tipoDeDiscapacidad; }

    public NivelDeDiscapacidad obtenerNivelDeDiscapacidad() { return nivelDeDiscapacidad; }
    public void establecerNivelDeDiscapacidad(NivelDeDiscapacidad nivelDeDiscapacidad) { this.nivelDeDiscapacidad = nivelDeDiscapacidad; }
}